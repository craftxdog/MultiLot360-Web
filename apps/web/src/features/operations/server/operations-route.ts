...
export function assertOperationsOrigin(request: Request) { if (!isTrustedMutationOrigin(request.url, request.headers.get("origin"))) throw new RouteError("Origen de solicitud no permitido.", 403); }
